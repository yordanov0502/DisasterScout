    ...
    <div className="military_conditions_component">
       ...
       >
            ...
            <ol>
                ...
                <li><span style={{fontWeight: 'bold'}}>Потърсете убежище:</span> Ако сте в сградата, намерете вътрешно помещение, далеч от прозорци и външни стени. Подземни помещения като мазета са за предпочитане.</li> 
