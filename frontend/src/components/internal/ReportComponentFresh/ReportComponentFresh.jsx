...
import "./report_component_fresh.scss";
...
export const ReportComponentFresh = ({ 
                                        isLoadingComponent,
                                        isRequestSent,
                                        reportForm, 
                                        handleInput, 
    ...
    {
        return (
          <div className="report_component_fresh">
            <div className="report_component_fresh__loader-box">
              <ComponentLoader />
            </div>
          </div>
        );
    ...
    else
    {
      return (
        ...
        <div className="report_component_fresh__container1">
    
         <img className="report_component_fresh__container1__image"
            src={reportForm.imageUrl || noImageUrl}
            alt={""} 
         />
    
         <div className="report_component_fresh__container1__wrapper1">
    ...
    <TextField //TODO: in the public website implement onClick for the buton google maps
         ...
         color="success"
         margin="dense"
         error={errorFreshForm.locationUrl}
       ...
       />
        ...
        <div className="report_component_fresh__container2">
    
        <div className="report_component_fresh__container2__description">
        <TextField
              ...
              color="success"
              margin="dense"
              error={errorFreshForm.description}
              value={reportForm.description}
              onChange={(e) => handleInput(e.target.name, e.target.value)} 
            />
        </div>
    
        <div className="report_component_fresh__container2__box3"> 
        <TextField
         sx={{backgroundColor: 'white'}}
         autoComplete="off"
    ...
    <TextField
       ...
       />
        ...
        <div className="report_component_fresh__buttons-container">
          <button type="button" className="report_component_fresh__buttons-container__update" disabled={isRequestSent} onClick={onPressUpdate}>{"Актуализирай"}</button>
          <button type="button" className="report_component_fresh__buttons-container__terminate" disabled={isRequestSent} onClick={onPressTerminate}>{"Прекрати"}</button>
        </div>
