...
public class CorsConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOriginPatterns(List.of("https://localhost"/*,"https://192.168.1.7"*/)); //? allowedOriginPatterns can be used in combination with setAllowCredentials set to true.
