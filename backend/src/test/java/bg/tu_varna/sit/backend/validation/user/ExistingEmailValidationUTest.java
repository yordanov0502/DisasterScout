...
class ExistingEmailValidationUTest {
    ...
    void isValid_withDifferentEmail_shouldReturnTrue() {
        ...
        User authenticatedUser = new User("6505d8f5bbda1e36bbc2bdea","Todor","Yordanov","auth@example.com","tosheto","ASas2@dsadas12", ADMIN, ACTIVE, OFFLINE, new Date(),0,new ArrayList<>(List.of(1)));
